...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Affan mulla web design",
    "Affan mulla portfolio",
    "Website designer in Gujarat",
    "Freelance web designer in Gujarat",
    "Web designer for local businesses in Gujarat",
    "affan mulla web designer and developer",
    "Freelance web designer and developer in Gujarat",
    "Web designer and developer for local businesses in Gujarat",
    "affan mulla website design and SEO",
    "SEO specialist for local businesses in Gujarat",
    "SEO services for local businesses in Gujarat",
    "affan mulla local SEO",
    "local SEO for small businesses in Gujarat",
    "local SEO for restaurants in Gujarat",
    "local SEO for contractors in Gujarat",
    "local SEO for service businesses in Gujarat",
    "Affan mulla landing page design",
    "Landing page designer for local businesses in Gujarat",
    "affan mulla affordable website design",
    "Affordable website design for local businesses in Gujarat",
  ],
  alternates: {
    canonical: "https://byaffan.com/",
  },
  openGraph: {
