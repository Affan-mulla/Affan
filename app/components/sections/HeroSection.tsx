  ...
  return (
    ...
    >
      ...
      <div className="space-y-6">
        ...
        <p className="max-w-md text-lg leading-9 text-(--color-text-muted)">
          Building portfolio websites and product interfaces that look premium, feel smooth, and help
          freelancers attract better leads.
        </p>
      </div>
      ...
      <div className="flex flex-col items-start justify-end gap-3 md:items-end">
        ...
        <span className="inline-flex rounded-full border border-(--color-border) px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-(--color-text-muted)">
          Gujarat, India
        </span>
        <span className="inline-flex rounded-full border border-(--color-border) px-4 py-2 text-xs font-semibold uppercase tracking-[0.12em] text-(--color-text-muted)">
      ...
      >
        <span className="relative h-16 w-px overflow-hidden bg-(--color-border)">
          <motion.span
        ...
        <span className="text-[10px] font-semibold uppercase tracking-[0.24em] text-(--color-text-muted)">
          Scroll
        </span>
      </motion.div>
    </motion.section>
