# David Rodriguez — Senior Product Designer

## Mission
Create implementation-ready, token-driven UI guidance for David Rodriguez — Senior Product Designer that is optimized for consistency, accessibility, and fast delivery across dashboard web app.

## Brand
- Product/brand: David Rodriguez — Senior Product Designer
- URL: https://dvdrod.com/
- Audience: authenticated users and operators
- Product surface: dashboard web app

## Style Foundations
- Visual style: clean, functional, implementation-oriented
- Main font style: `font.family.primary=Inter`, `font.family.stack=Inter, system-ui, sans-serif`, `font.size.base=16px`, `font.weight.base=400`, `font.lineHeight.base=normal`
- Typography scale: `font.size.xs=10px`, `font.size.sm=11px`, `font.size.md=12px`, `font.size.lg=13px`, `font.size.xl=13.33px`, `font.size.2xl=14px`, `font.size.3xl=15px`, `font.size.4xl=16px`
- Color palette: `color.text.primary=#0c0c0b`, `color.text.secondary=#5b5a57`, `color.surface.base=#000000`, `color.surface.muted=#f0ede5`, `color.border.strong=rgb(12, 12, 11) rgb(12, 12, 11) rgba(12, 12, 11, 0.1)`
- Spacing scale: `space.1=2px`, `space.2=4px`, `space.3=7px`, `space.4=8px`, `space.5=10px`, `space.6=14px`, `space.7=15px`, `space.8=16px`
- Radius/shadow/motion tokens: `radius.xs=14px`, `radius.sm=100px` | `motion.duration.instant=200ms`, `motion.duration.fast=300ms`, `motion.duration.normal=400ms`, `motion.duration.slow=450ms`, `motion.duration.slower=900ms`
...
- Include known page component density: cards (53), links (11), lists (3), buttons (2), navigation (1).
...
## Extracted CSS of refrence website 
```css
@font-face {
	font-family: "Inter";
	font-style: italic;
...
@font-face {
	...
	font-weight: 700;
	font-display: swap;
	src: url("https://fonts.gstatic.com/s/syne/v24/8vIS7w4qzmVxsWxjBZRjr0FKM_3fvj6k.ttf") format("truetype");
}
...
@font-face {
	...
	font-weight: 800;
	font-display: swap;
	src: url("https://fonts.gstatic.com/s/syne/v24/8vIS7w4qzmVxsWxjBZRjr0FKM_24vj6k.ttf") format("truetype");
}
/* ============================================
       VARIABLES & THEMES
    ============================================ */
...
article.pcard.p-caixabank {
	cursor: none;
}

article.pcard.p-gymondo1 {
	cursor: none;
}

article.pcard.p-gymondo2 {
	cursor: none;
}

article.pcard.p-zattoo {
	cursor: none;
}

article.pcard.p-nt-onboarding {
	cursor: none;
}

article.pcard.p-nt-quests {
	cursor: none;
}
...
article.pcard.p-nt-referral.pcard--wip {
	cursor: none;
}
...
```
- Use this As refrence and add the following CSS to your stylesheet to implement the custom cursor and noise overlay.
- Also Use tailwind css and only use vanila css if necessary.